...
// option 4: AddEventListner

// workProcedure- getElementById("").addEventListener("event type", handler)
document.getElementById("btn-make-green").addEventListener("click", function makeGreen() {
    document.body.style.backgroundColor = "green";
})


document.getElementById("btn-make-gold").addEventListener("click", function makeGreen() {
